...
const GALLERY: FanPost[] = [
  {
    id: 1,
    title: "Messi's Final Crusade",
    author: "@futbol_art",
    tag: "Legendary",
    tagColor: "#ffd700",
    emoji: "⭐",
    gradient: "linear-gradient(135deg,#1a0533,#0d0033,#1a0a00)",
    likes: 2847,
    desc: "The greatest of all time leading his nation one last time. Pure gold.",
  },
  {
    id: 2,
    ...
    tagColor: "#ff3366",
    emoji: "🔥",
    gradient: "linear-gradient(135deg,#330000,#1a0010,#0d0a00)",
    likes: 3120,
    desc: "Still hunting that elusive World Cup trophy. The hunger never dies.",
  },
  {
    id: 3,
    title: "USA Rise Up",
    ...
    tagColor: "#00d4ff",
    emoji: "🇺🇸",
    gradient: "linear-gradient(135deg,#001a33,#00001a,#1a001a)",
    likes: 1564,
    desc: "The USA hosting for the first time since 1994. Electric.",
  },
  {
    id: 4,
    title: "Neon Azteca Opening",
    author: "@mexifutbol",
    tag: "Opening",
    tagColor: "#00ff88",
    emoji: "🇲🇽",
    gradient: "linear-gradient(135deg,#001a00,#0d1a00,#1a0000)",
    likes: 4201,
    desc: "Estadio Azteca lit up for the opening match. Goosebumps.",
  },
  {
    id: 5,
    title: "Brazil Samba Dance",
    author: "@sambafc",
    tag: "Culture",
    tagColor: "#ffd700",
    emoji: "💛",
    gradient: "linear-gradient(135deg,#0d1a00,#001a0d,#001a00)",
    likes: 2099,
    desc: "Brazil bringing the festival to the pitch. Nothing like it.",
  },
  {
    id: 6,
    title: "France — Les Bleus Reborn",
    author: "@parisgoal",
    tag: "Favorite",
    tagColor: "#00d4ff",
    emoji: "🔵",
    gradient: "linear-gradient(135deg,#00001a,#001133,#1a0000)",
    likes: 1876,
    desc: "Three-time champion. The blueprint for modern football.",
  },
  {
    id: 7,
    title: "Germany Machine Reloaded",
    author: "@bundesart",
    tag: "Dark Horse",
    tagColor: "#bf5fff",
    emoji: "⚙️",
    gradient: "linear-gradient(135deg,#0d0d0d,#1a001a,#0d0d00)",
    likes: 1432,
    desc: "Germany rebuilt and ready. Watch out for the machine.",
  },
  {
    id: 8,
    title: "England — It's Coming Home??",
    author: "@threelions",
    tag: "Meme",
    tagColor: "#ff3366",
    emoji: "😭",
    gradient: "linear-gradient(135deg,#1a0010,#00001a,#0d0000)",
    likes: 6712,
    desc: "The eternal optimism of English fans. The meme that never dies.",
  },
  {
    id: 9,
    title: "MetLife Final Render",
    author: "@stadiumart",
    tag: "Venue Art",
    tagColor: "#ffd700",
    emoji: "🏟️",
    gradient: "linear-gradient(135deg,#0d0d22,#0a0a1a,#1a0d00)",
    likes: 3341,
    desc: "The venue of the century. MetLife Stadium under the lights.",
  },
  {
    id: 10,
    title: "Canada's Moment",
    author: "@leafgoal",
    tag: "Underdog",
    tagColor: "#ff3366",
    emoji: "🍁",
    gradient: "linear-gradient(135deg,#1a0000,#0d001a,#1a0000)",
    likes: 2234,
    desc: "Canada's first World Cup in 40 years. The nation is READY.",
  },
  {
    id: 11,
    title: "Morocco Magic",
    ...
    tagColor: "#ff9900",
    emoji: "🌍",
    gradient: "linear-gradient(135deg,#1a0d00,#0d0000,#0d0000)",
    likes: 2891,
    desc: "2022's Cinderella story looking to repeat the magic.",
  },
  {
    id: 12,
    title: "Japan — Blue Samurai 2026",
    author: "@japanfc",
    tag: "Asia",
    tagColor: "#00d4ff",
    emoji: "⚔️",
    gradient: "linear-gradient(135deg,#00001a,#1a0000,#00001a)",
    likes: 1987,
    desc: "Japan quietly building one of the best squads in the world.",
  },
];
...
export default function GalleryPage() {
  ...
  function openLightbox(post: FanPost) {
    setLightbox(post);
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm max-w-md mx-auto" style={{ color: "#7070a0", lineHeight: "1.8" }}>
            The wildest, craziest, most creative FIFA 2026 fan art and edits. Curated by the
            community.
          </p>
        </div>
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 space-y-4">
          {filtered.map((post) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow =
                  `0 0 30px ${post.tagColor}15, 0 8px 40px rgba(0,0,0,0.5)`;
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: "5rem", filter: `drop-shadow(0 0 20px ${post.tagColor})` }}
                >
                  {post.emoji}
                </span>
                {/* Overlay on hover */}
              ...
              <div className="p-4" style={{ borderTop: `1px solid ${post.tagColor}15` }}>
                ...
                <div className="flex items-center justify-between">
                  <button
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.color = liked.has(post.id) ? "#ff3366" : "#7070a0")
                    }
                  >
        ...
        >
          ...
          >
            Got a crazy FIFA 2026 edit? Fan art? A legendary meme?
            <br />
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center" style={{ height: "280px" }}>
              <span
                style={{ fontSize: "8rem", filter: `drop-shadow(0 0 30px ${lightbox.tagColor})` }}
              >
                {lightbox.emoji}
              </span>
            </div>
            ...
            <div className="p-6" style={{ borderTop: `1px solid ${lightbox.tagColor}20` }}>
              <span
                ...
                style={{
                  borderColor: `${lightbox.tagColor}50`,
                  color: lightbox.tagColor,
                  background: `${lightbox.tagColor}10`,
                }}
              >
                {lightbox.tag}
              </span>
              ...
              <p className="text-xs mb-3" style={{ color: lightbox.tagColor }}>
                by {lightbox.author}
              </p>
