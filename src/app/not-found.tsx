...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 bg-grid">
      <p
      ...
      <p className="text-sm mb-8 max-w-sm" style={{ color: "#7070a0", lineHeight: "1.8" }}>
        This page does not exist. Maybe the match was cancelled, or you took a wrong turn at the
        group stage.
      </p>
