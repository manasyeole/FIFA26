          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              >
                ...
                <div>
                  <p className="font-orbitron font-bold text-sm" style={{ color: c.color }}>
                    {c.name}
                  </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/schedule"
              className="flex items-center gap-2 font-orbitron text-xs tracking-widest uppercase"
              style={{ color: "#00ff88" }}
            >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
              ...
              style={{ background: "rgba(13,13,34,0.8)", border: "1px solid rgba(255,215,0,0.2)" }}
            >
              <div
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-orbitron font-black text-xl mb-3" style={{ color: "#ffd700" }}>
                  Road to the Final
                </h2>
                <p className="text-sm mb-6" style={{ color: "#7070a0", lineHeight: "1.8" }}>
                  Group Stage → Round of 32 → Round of 16 → QF → SF → Final.
                  <br />
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(255,51,102,0.04) 0%, transparent 70%)",
                }}
              />
              <div className="relative z-10">
                <div className="text-5xl mb-4">🔥</div>
                <h2 className="font-orbitron font-black text-xl mb-3" style={{ color: "#ff3366" }}>
                  Fan Art & Crazy Edits
                </h2>
                <p className="text-sm mb-6" style={{ color: "#7070a0", lineHeight: "1.8" }}>
                  The wildest fan-made FIFA 2026 edits, meme moments,
                  <br />
                  and pure football art — all in one place.
                </p>
                <Link
                  href="/gallery"
                  className="btn-neon btn-neon-pink inline-flex items-center gap-2"
                >
